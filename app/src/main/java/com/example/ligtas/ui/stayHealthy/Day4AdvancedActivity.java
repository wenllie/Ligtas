...
public class Day4AdvancedActivity extends AppCompatActivity implements View.OnClickListener {

    AppCompatButton day4AdvancedContinueButton;
    AppCompatImageView day4AdvancedBackButton;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_day4_advanced);

        day4AdvancedContinueButton = findViewById(R.id.day4AdvancedContinueButton);
        day4AdvancedBackButton = findViewById(R.id.day4AdvancedBackButton);


        day4AdvancedContinueButton.setOnClickListener(this);
        day4AdvancedBackButton.setOnClickListener(this);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        Intent toStayHealthy = new Intent(Day4AdvancedActivity.this, AdvancedWorkoutActivity.class);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.day4AdvancedContinueButton:
                                        ...
                                        if (userIdKey.equalsIgnoreCase(FirebaseAuth.getInstance().getUid())) {
                                            ...
                                            for (DataSnapshot workoutSnap : userIdSnap.getChildren()) {
                                                ...
                                                if (workoutkey.equalsIgnoreCase("Workouts")) {
                                                        ...
                                                        if (typeKey.equalsIgnoreCase("Advanced")) {
                                                            ...
                                                            for (DataSnapshot daySnap : typeSnap.getChildren()) {
                                                                ...
                                                                if (dayKey.equalsIgnoreCase("Day 4")) {
                                                                    ...
                                                                    Toast.makeText(Day4AdvancedActivity.this, "You're already done for day 4!", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    workoutReference.child(userTypeKey).child(idNumberKey).child(userIdKey).child("Workouts").child("Advanced").child("Day 4").child("Result").setValue("Completed");
                                                    Intent toStayHealthy = new Intent(Day4AdvancedActivity.this, AdvancedWorkoutActivity.class);
                                                    toStayHealthy.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                                    toStayHealthy.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                                    startActivity(toStayHealthy);
            ...
            case R.id.day4AdvancedBackButton:
                onBackPressed();
                break;
