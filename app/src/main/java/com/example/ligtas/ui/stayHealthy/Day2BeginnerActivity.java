    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.day2Ex1StartButton:
                ...
                Glide.with(this).load(R.drawable.squats_exercise).into(beginner_day2_ex1_photo);
                break;
            ...
            case R.id.day2Ex2NextButton:
                ...
                Glide.with(this).load(R.drawable.squats_exercise).into(beginner_day2_ex3_photo);
                break;
            ...
            case R.id.day2Ex3NextButton:
                ...
                Glide.with(this).load(R.drawable.squats_exercise).into(beginner_day2_ex4_photo);
                break;
            ...
            case R.id.day2Ex4NextButton:
                ...
                Glide.with(this).load(R.drawable.squats_exercise).into(beginner_day2_ex5_photo);
                break;
            ...
            case R.id.day2Ex5NextButton:
                ...
                Glide.with(this).load(R.drawable.squats_exercise).into(beginner_day2_ex6_photo);
                break;
            ...
            case R.id.day2Ex6NextButton:
                ...
                Glide.with(this).load(R.drawable.squats_exercise).into(beginner_day2_ex7_photo);
                break;
            ...
            case R.id.day2Ex7NextButton:
                ...
                Glide.with(this).load(R.drawable.squats_exercise).into(beginner_day2_ex8_photo);
                break;
                                        ...
                                        if (userIdKey.equalsIgnoreCase(FirebaseAuth.getInstance().getUid())) {
                                            ...
                                            for (DataSnapshot workoutSnap : userIdSnap.getChildren()) {
                                                ...
                                                if (workoutkey.equalsIgnoreCase("Workouts")) {
                                                    ...
                                                    workoutReference.child(userTypeKey).child(idNumberKey).child(userIdKey).child("Workouts").child("Day 2").child("Result").setValue("Completed");
                                                    Intent toStayHealthy = new Intent(Day2BeginnerActivity.this, BeginnerWorkoutActivity.class);
                                                    toStayHealthy.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                                    toStayHealthy.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                                    startActivity(toStayHealthy);
