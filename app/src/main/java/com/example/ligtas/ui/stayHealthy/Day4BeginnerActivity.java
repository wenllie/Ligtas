...
public class Day4BeginnerActivity extends AppCompatActivity implements View.OnClickListener {

    AppCompatButton day4BeginnerContinueButton;
    AppCompatImageView day4BackButton;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_day4_beginner);

        day4BeginnerContinueButton = findViewById(R.id.day4BeginnerContinueButton);
        day4BackButton = findViewById(R.id.day4BackButton);


        day4BeginnerContinueButton.setOnClickListener(this);
        day4BackButton.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.day4BeginnerContinueButton:
                                        ...
                                        if (userIdKey.equalsIgnoreCase(FirebaseAuth.getInstance().getUid())) {
                                            ...
                                            for (DataSnapshot workoutSnap : userIdSnap.getChildren()) {
                                                ...
                                                if (workoutkey.equalsIgnoreCase("Workouts")) {
                                                        ...
                                                        if (typeKey.equalsIgnoreCase("Beginner")) {
                                                            ...
                                                            for (DataSnapshot daySnap : typeSnap.getChildren()) {
                                                                ...
                                                                if (dayKey.equalsIgnoreCase("Day 4")) {
                                                                    ...
                                                                    Toast.makeText(Day4BeginnerActivity.this, "You're already done for day 4!", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    workoutReference.child(userTypeKey).child(idNumberKey).child(userIdKey).child("Workouts").child("Beginner").child("Day 4").child("Result").setValue("Completed");
                                                    Intent toStayHealthy = new Intent(Day4BeginnerActivity.this, BeginnerWorkoutActivity.class);
                                                    toStayHealthy.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                                    toStayHealthy.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                                    startActivity(toStayHealthy);
